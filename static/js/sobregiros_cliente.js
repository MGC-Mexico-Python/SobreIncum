...
function obtenerDatos() {
    if (esMonto && esSemanas)   return { datos: window.grafSemanalMonto,   labelKey: 'Fecha', valorKey: 'Monto sobregiro',  titulo: 'Monto por semana',   esMonto: true  };
    if (esMonto && !esSemanas)  return { datos: window.grafMensualMonto,   labelKey: 'Fecha', valorKey: 'Monto sobregiro',  titulo: 'Monto por mes',      esMonto: true  };
